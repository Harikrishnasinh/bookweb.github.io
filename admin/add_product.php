    ...
    <form class="p-4" action="insert.php" method="POST">
        <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Enter Category Name" name="cat_name" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
            </div>
        </div>
        <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-folder"></i></span>
                <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Enter Category Image" aria-label="John Doe" name="cat_img" aria-describedby="basic-icon-default-fullname2" />
            </div>
        </div>
