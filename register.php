<?php
    ...
    $insert = "INSERT INTO `register`(`username`, `firstname`, `lastname`, `mobile`, `birthdate`, `email`, `password`) VALUES ('$username','$firstname','$lastname','$mobile','$birthdate','$email','$password')";
    $query = mysqli_query($con,$insert);
    if($query){
        header("location:login.php");
    }else{
        ?><script>alert("please register properly...")</script><?php
    }
}
?>
                ...
                <div class="form-right">
                    <div class="container">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control w-25" placeholder="Username" name="username" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
